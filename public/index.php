...
$app->map(['POST', 'GET'], '/deleteorder/{id}', 'OrderController:delOrder');
$app->map(['POST', 'GET'], '/editorder/{id}', 'OrderController:editOrder');

// Routes depuis l'application
...
$app->get('/toporders', 'MobileController:viewMobileTopDeal');
