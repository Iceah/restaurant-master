...
import com.inkweb.androidfoodordering.adapter.CategoryAdapter;
import com.inkweb.androidfoodordering.entities.MenuCategoryObject;
            ...
            public void onResponse(MenuCategoryObject[] response) {
                try {
                    ...
                    if(response.length > 0){
                        ...
                        Toast.makeText(getActivity(), "Le restaurant ne propose actuellement pas de menu", Toast.LENGTH_LONG).show();
                        return;
                    }
                } catch (Exception e) {
                    e.printStackTrace();
