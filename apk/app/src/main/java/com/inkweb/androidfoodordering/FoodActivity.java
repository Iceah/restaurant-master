...
import com.inkweb.androidfoodordering.entities.MenuItemObject;
...
public class FoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favoriteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // TODO : Gérer favoris déjà enregistré //
                Helper.displayErrorMessage(FoodActivity.this, "Ajouté à vos favoris");
    ...
    private void showCustomizeOrderDialog(){
        ...
        builder.setTitle("Demande particulière");
        ...
        builder.setNegativeButton("Annuler", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(FoodActivity.this, "Aucune option ajoutée", Toast.LENGTH_LONG).show();
            }
        });
        builder.show();
    }
