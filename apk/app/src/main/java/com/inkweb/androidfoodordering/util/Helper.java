package com.inkweb.androidfoodordering.util;
...
public class Helper {
    ...
    public static final String PUBLIC_FOLDER = "https://backresto.inkweb.fr/";
    ...
    public static final String NEW_ACCOUNT = "Vous n'avez pas encore de compte ?";
    ...
    public static String dateFormatting(String dateInString){
        SimpleDateFormat sdfDestination = new SimpleDateFormat("yyyy-MM-dd", Locale.FRENCH);
        ...
        return new SimpleDateFormat("d MMMM, yyyy", Locale.FRENCH).format(stringDate);
    }
