...
import com.inkweb.androidfoodordering.adapter.CustomViewPagerAdapter;
import com.inkweb.androidfoodordering.entities.HotDealObject;
            ...
            public void onResponse(HotDealObject[] response) {
                try {
                    ...
                    if(response.length > 0){
                        ...
                        mAdapter = new CustomViewPagerAdapter(HotDealActvity.this, hotDealList);
                        Toast.makeText(HotDealActvity.this, "Il n'y a pas encore de menu pour le restaurant", Toast.LENGTH_LONG).show();
                        return;
                    }
                } catch (Exception e) {
                    e.printStackTrace();
