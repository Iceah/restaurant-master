  	...
  	<div class="container">
  		...
  		<div class="row">
            ...
            <?php include_once 'secondarynavigation.php' ?>
  			...
  			<div class="col-md-9 remove-padding">
					<div class="first-header right-side-column">
	  				<h4 class="add-margin-left"><strong class="color-white">Gestion de comptes</strong> <span style="color:#e74c3c; font-size: 14px; float:right;"> <?php $today = date("j M, Y"); echo $today; ?></span></h4>
			 </div>
			 ...
			 <div class="business-header">  </div>
  			...
  			<div class="row pad-left">
                ...
                <div class="panel-body  color-white">Modifications des informations personnelles</div>
            </div>
  				</div>
  			</div>
            ...
            <form method="POST" action="user">
              ...
              <div class="col-md-4 user-row text-right"><label class="form-title-adjustment" for="inputEmail">Addresse:</label></div>
              <div class="col-md-8 mix"> <input type="text" name="address" class="form-control" required id="inputFirstName" value="<?php if(isset($edit)) echo $edit->address; ?>"></div>
							...
							<div class="col-md-4 user-row text-right"><label class="form-title-adjustment" for="inputEmail">Numéro de téléphone:</label></div>
              ...
              <button type="submit" class="btn btn-default button-position right-side-column color-white">Sauvegarder</button>
              </div>
            </form>
  				</div>
  			</div>
