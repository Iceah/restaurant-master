  ...
  <body>
  	...
  	<div class="container">
        ...
        <div class="row add-margin">
          <div class="col-md-12">
            <h3 style="color:white"> Edition d'une commande </h3>
          </div>
        </div>
        ...
        <div class="row pad-left">
          <div class="col-md-12">
            ...
            <div><h4 style="color:yellow;"> <?php if(isset($order)) echo "Voulez-vous modifier " . $order->order_id . " ?"; ?> </h4></div>
              <form method="POST" action="" enctype="multipart/form-data">
                ...
                <tbody>
                  <tr>
                    <td>Status:</td>
                    <td>
                        <p>Selectionner un status</p>
                        <select name="status" class="mform-field">
                            <option value="Commande reçue">Commande reçue</option>
                            <option value="Commande en cours">Commande en cours</option>
                            <option value="Commande envoyée">Commande envoyée</option>
              ...
              <button type="submit" class="btn btn-default button-position color-white">Mettre à jour</button> </div>
              </form>
            </div>
          </div>
  			</div>
