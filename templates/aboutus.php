  	...
  	<div class="container">
        ...
        <div class="row">
          ...
          if(isset($restaurant)){ ?>
            ...
            <div class="col-md-5 pad-left para-wrap">
              <h4 class="sub-titles color-yellow"> Contact </h4>
              <p>Addresse: <?php echo $restaurant->address; ?></p>
              <p>Numéro de téléphone: <?php echo $restaurant->phone; ?></p>
              <p>Email: <?php echo $restaurant->email; ?></p>

              <h4 class="sub-titles color-yellow">Heures d'ouverture</h4>
        ...
        ?>
          ...
          <div class="edit-button-wrapper">
            <a class="btn btn-default second-background color-white" href="editaboutus" role="button">Modifier les informations</a>
          </div>
