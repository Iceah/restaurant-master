    ...
    <div class="row">
        ...
        <div class="col-md-9 remove-padding">
            <div class="first-header right-side-column">
                <h4 class="add-margin-left"><strong class="color-white">Gestion des comptes</strong> <span
                            style="color:#e74c3c; font-size: 14px; float:right;"> <?php $today = date("j M , Y");
                        echo $today; ?></span></h4>
            </div>
                ...
                <div class="col-md-12">
                    <a href="adduser">
                        <button type="submit" class="btn btn-primary btn-lg">
                            <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Ajouter un compte
                        </button>
                    </a>
                </div>
            </div>
                        ...
                        if (isset($users)) {
                            ...
                            foreach ($users as $user) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php if (isset($user->solde)) echo  $user->solde;?></td>

                                    <td><a href="edituser/<?php if (isset($user->id)) echo $user->id ?>"><span
                                                    class="glyphicon glyphicon-edit color-white"
                                                    aria-hidden="true"></span></a>
                                        <a href="userdelete/<?php if (isset($user->id)) echo $user->id ?>"><span
                                                    class="glyphicon glyphicon-trash color-red mDelete"
